...
//delete product
   ...
   $scope.deleteProduct = function () {
    ...
    /*$scope.updateProduct = function (productId,productName,productDesc,productType,quantity) {
	alert('upadte');
    ProductCRUDService.updateProduct(productId,productName,productDesc,productType,quantity)
      .then(function success(response){
    	  alert('in update');
...
app.controller('ordercontroller', ['$scope','OrderCRUDService', function ($scope,OrderCRUDService) {
	...
	//update order 
	 ...
	 $scope.updateOrder = function () {
		 OrderCRUDService.updateOrder($scope.orderName,$scope.orderPrice,$scope.productId,$scope.orderStatus)
	          .then(function success(response){
...
app.service('OrderCRUDService',['$http', function ($http) {
		...
		*/
	    ...
	    //update order
	    this.updateOrder = function updateOrder(orderName,orderPrice, productId,orderStatus){
	        return $http({
	          method: 'PUT',
	          url: 'updateOrder',
	          data: {orderName:orderName,orderPrice:orderPrice, productId:productId, orderStatus:orderStatus}
